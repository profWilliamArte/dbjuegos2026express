...
-- Tiempo de generación: 05-06-2026 a las 19:57:37
...
--
-- Base de datos: `dbjuegos2026`
--
CREATE DATABASE IF NOT EXISTS `dbjuegos2026` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `dbjuegos2026`;
...
INSERT INTO `generos` (`id`, `estatus_id`, `nombre`, `descripcion`) VALUES
...
INSERT INTO `juegos` (`id`, `estatus_id`, `genero_id`, `nombre`, `descripcion`, `fechapublicacion`, `precio`, `valoracion`, `imagen`) VALUES
...
(115, 1, 1, 'prueba con plataformas', 'prueba', '2025-10-22', 15.00, 40, 'juego-1761161697275-536135575.png'),
(116, 1, 1, 'prueba333333', '32323', '2025-10-22', 32.00, 3, 'juego-1761162292933-382128015.png'),
(117, 1, 1, 'Prueba 4', '121212', '2025-10-22', 21.00, 22, 'juego-1761163065966-175762420.png'),
(118, 1, 1, 'sadasda', 'erterter ert erte', '2025-10-22', 44.00, 44, 'juego-1761163151565-788958015.jpg'),
(119, 1, 2, 'prueba 8www', 'sdsds', '2025-10-22', 454.00, 44, 'juego-1761163643129-975642456.jpg'),
(120, 1, 1, 'prueba54', '32323', '2025-10-22', 23.00, 23, 'juego-1761164742673-239854640.png'),
(121, 1, 1, 'pruebaddd', '323232  sdfsdfsd sd', '2025-10-22', 33.00, 2, 'juego-1761165592978-265144831.jpg');
...
INSERT INTO `juegos_plataformas` (`id`, `juego_id`, `plataforma_id`) VALUES
(1, 1, 1),
(2, 2, 1),
(3, 3, 1),
(4, 4, 1),
...
INSERT INTO `plataformas` (`id`, `estatus_id`, `nombre`, `descripcion`) VALUES
